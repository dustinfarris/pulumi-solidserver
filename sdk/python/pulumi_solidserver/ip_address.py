...
class IPAddress(pulumi.CustomResource):
    ...
    request_ip: pulumi.Output[str]
    space: pulumi.Output[str]
    subnet: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, class_=None, class_parameters=None, device=None, mac=None, name=None, request_ip=None, space=None, subnet=None, __name__=None, __opts__=None):
        """
        ...
        __props__['request_ip'] = request_ip
